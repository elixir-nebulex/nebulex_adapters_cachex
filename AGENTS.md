## Local Scope First (`nebulex_adapters_cachex`)

This repository is `nebulex_adapters_cachex` (the Cachex adapter for Nebulex),
...
- `lib/nebulex/adapters/cachex.ex` - Main Cachex adapter implementation.
- `lib/nebulex/adapters/cachex/custom_actions/` - Custom Cachex actions (fetch, get_all, put_new, etc.).
- `lib/nebulex/adapters/cachex/ets_utils.ex` - ETS utility helpers.
- `lib/nebulex/adapters/cachex/router.ex` - Command routing.
- `test/nebulex/adapters/cachex/local_test.exs` - Local adapter behavior tests.
- `test/nebulex/adapters/cachex/cachex_error_test.exs` - Cachex error handling tests.
- `test/nebulex/adapters/cachex/info_test.exs` - Cache info tests.
- `test/nebulex/adapters/cachex/stats_test.exs` - Stats tests.
- `test/nebulex/adapters/cachex/transaction_test.exs` - Transaction tests.
- `test/shared/` - Shared test cases (cachex, queryable, expiration, persistence).
